...
{{< section-container class="py-20 bg-white" >}}
    <div class="max-w-4xl mx-auto text-center">
        <div class="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-12 border-2 border-blue-200">
            <h2 class="text-3xl font-bold text-gray-900 mb-4">Coming at 100 Members</h2>
            <p class="text-xl text-gray-700 mb-8">
                We're developing business and enterprise membership solutions for teams and organizations that want the same privacy-first, community-driven infrastructure at scale.
            </p>
            <p class="text-lg text-gray-600 mb-8">
                At 100 members, we'll begin offering business and enterprise memberships for teams and organizations. Interested in learning more? Get in touch and we'll notify you when business solutions are available.
            </p>
