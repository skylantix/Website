...
<h3 class="text-xl font-bold text-gray-900 mb-2">Rock-Solid Security</h3>
...
<details class="group">
<summary class="flex justify-between items-center cursor-pointer list-none p-4 bg-white rounded-lg hover:bg-gray-50 transition shadow-sm">
<span class="font-semibold text-gray-900">Can I get more storage?</span>
<span class="transition group-open:rotate-180">
<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
</svg>
...
<details class="group">
<summary class="flex justify-between items-center cursor-pointer list-none p-4 bg-white rounded-lg hover:bg-gray-50 transition shadow-sm">
<span class="font-semibold text-gray-900">What makes Skylantix different from other hosting?</span>
<span class="transition group-open:rotate-180">
<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
</svg>
...
<details class="group">
<summary class="flex justify-between items-center cursor-pointer list-none p-4 bg-white rounded-lg hover:bg-gray-50 transition shadow-sm">
<span class="font-semibold text-gray-900">What support do I get?</span>
<span class="transition group-open:rotate-180">
<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
</svg>
...
<p class="mt-3 text-gray-600 px-4">Personal support via Mattermost or email. No ticket bureaucracy. You'll talk to a real human who actually manages the infrastructure. This is a digital village—your sysadmin knows your name.</p>
</details>

<details class="group">
<summary class="flex justify-between items-center cursor-pointer list-none p-4 bg-white rounded-lg hover:bg-gray-50 transition shadow-sm">
<span class="font-semibold text-gray-900">What are the perks for early members?</span>
<span class="transition group-open:rotate-180">
<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
</svg>
